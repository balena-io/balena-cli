...
* os configure: Clarify that the image's config.json is always replaced [Thodoris Greasidis]

## 25.2.5 - 2026-08-18

* os download: Add debug logs [Thodoris Greasidis]

## 25.2.4 - 2026-08-17

* Treat 429 errors as expected [Pagan Gazzard]
...
* Support pinning devices that haven't completed their OS update back to their current release [Thodoris Greasidis]
* device os-update: Add support for Queued OS updates [Thodoris Greasidis]

## 25.1.10 - 2026-06-29

* Update apple-actions/import-codesign-certs action to v7 [balena-renovate[bot]]

## 25.1.9 - 2026-06-18

* Promote updateImage log from debug to info for deploy visibility [Shaun Mulligan]
* Fix progress bar clamping bug and improve push upload feedback [Shaun Mulligan]
...
* Bump @balena/compose-parser to 0.2.6, @balena/compose to 8.0.4 [Christina Ying Wang]
