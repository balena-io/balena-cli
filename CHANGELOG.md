...
* WIP: Allow tunneling to remote unix sockets. [Carlo Miguel F. Cruz]
* Add tunnel for logs command [Josh Bowling]
* More cleanup [Josh Bowling]
* Clean up code [Josh Bowling]
* Add ability to push to remote device UUID [Josh Bowling]
