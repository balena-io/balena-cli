...
* Add docker-compose-aware builds and deployments #782 [Akis Kesoglou]
* *BREAKING*: Remove support for plugins entirely #782 [Tim Perry]
* Update dashboard login to use the multicontainer SDK #782 [Alexis Svinartchouk]
* Multicontainer preload: Update resin-preload to 6.0.0-beta4 #782 [Alexis Svinartchouk]
* Update the keys action to use the multicontainer SDK #782 [Alexis Svinartchouk]
* Require multicontainer SDK #782 [Alexis Svinartchouk]
